...
static void get_date( char chFullPath[MAX_PATH], char chDate[20] ) {
	...
	snprintf (chDate, 20, "%04d-%02d-%02d %02d:%02d:%02d", stFileDate.wYear, stFileDate.wMonth, stFileDate.wDay, stFileDate.wHour, stFileDate.wMinute, stFileDate.wSecond ); // YYYY-MM-DD HH:MM:SS
}
